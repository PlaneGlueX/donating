...
module.exports = async ({ check }) => {
  ...
  try {
    ...
    for (const c of ['dheist create ztrap 2', 'dheist set ztrap level 0', 'dheist set ztrap name Trap Hall', 'dheist set ztrap escape 600', 'dheist set ztrap cooldown 5', 'dheist exit ztrap 764.5 200 781.5 -90', 'dheist snapshot ztrap',
      'dheist create ztrapa 4', 'dheist set ztrapa level 0', 'dheist set ztrapa name Camera Room', 'dheist set ztrapa escape 600', 'dheist set ztrapa cooldown 5', 'dheist exit ztrapa 785.5 200 780.5 -90', 'dheist snapshot ztrapa']) await cmd(c)
    ...
    for (const c of ['dheist create ztrap 2', 'dheist set ztrap level 0', 'dheist set ztrap name Trap Hall']) await cmd(c)
